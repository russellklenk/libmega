...
/// enumerations. These functions are defined privately within other modules
/// as needed, but exposed publicly here. Functions in this module do not call
/// OpenGL API functions. Targets the OpenGL 3.3 Core profile.
...
{
    glBufferData(target, capacity, NULL, usage);
}
